...
const createProductSchema = z.object({
  body: z.object({
    ...
    image: z.string().refine((v) => v.startsWith('/') || v.startsWith('http://') || v.startsWith('https://'), { message: 'Image must be a valid URL or path starting with /' }),
...
const updateProductSchema = z.object({
  body: z.object({
    ...
    image: z.string().refine((v) => v.startsWith('/') || v.startsWith('http://') || v.startsWith('https://'), { message: 'Image must be a valid URL or path starting with /' }).optional(),
